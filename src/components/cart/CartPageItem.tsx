...
const CartPageItem = ({ product, quantity, cartItemId }: Props) => {
    ...
    return (
        <Paper
            elevation={4}
            sx={{ display: "flex", borderRadius: "10px", marginY: "20px", width: "100%", paddingX: "10px" }}
        >
            <Avatar sx={{ width: "156px", height: "156px", borderRadius: "10px" }} variant="square">
                <img
                    style={{ width: "156px", height: "156px", objectFit: "cover", aspectRatio: "1/1" }}
            ...
            <Box sx={{ display: "flex", flexDirection: "column", rowGap: "16px", marginY: "16px" }}>
                <Link to={"/product/" + product.slug}>
                    <Typography
                        variant="h6"
                        sx={{ fontSize: "18px", fontWeight: "500", textTransform: "capitalize", marginX: "10px" }}
                    >
                        {product.name}
                    </Typography>
                </Link>
                ...
                <Box sx={{ display: "flex", gap: "8px", alignItems: "center", marginX: "10px" }}>
                    ...
                    <Typography sx={{ color: "secondary.main", fontWeight: "450", fontSize: "15px" }}>
                ...
                <Box sx={{ display: "flex", flexDirection: "row", alignItems: "center", paddingBottom: "0px" }}>
                    <Button
                        ...
                        color="secondary"
                        disabled={quantity === 1}
                        onClick={() => dispatch(changeQuantity({ id: cartItemId, quantity: quantity - 1 }))}
                    >
            ...
            <IconButton
                ...
                onClick={() => dispatch(changeQuantity({ id: cartItemId, quantity: 0 }))}
                color="secondary"
            >

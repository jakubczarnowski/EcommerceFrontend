...
const Product = ({ product }: ProductProps) => {
    ...
    return (
        ...
        >
            ...
            >
                <Chip
                    sx={{ top: "10px", left: "10px", position: "absolute" }}
                    label="5% off"
                    variant="filled"
                    size="small"
                    color="secondary"
                />
                <IconButton
                    sx={{ padding: "5px", paddingBottom: "0", top: "7px", right: "15px", position: "absolute" }}
                    aria-label="favorite"
                ...
                <Link to={"/product/" + product.slug}>
                    <img
                        style={{ objectFit: "contain", width: "100%", height: "100%", aspectRatio: "1/1" }}
            ...
            <Box sx={{ display: "flex", padding: "1rem" }}>
                ...
                >
                    <Link to={"/product/" + product.slug}>
                        <Typography
                            sx={{ marginY: "5px", fontSize: "14px", fontWeight: "500" }}
                            mt={2}
                            variant="h3"
                            color="text.primary"
                        >
                    ...
                    <Typography
                        variant="subtitle1"
                        sx={{ fontSize: 14, color: "secondary.main", marginY: "5px", fontWeight: "600" }}
                    >
                        ${product.price}
                    </Typography>
                </Box>
                {existsInCart ? (
                    ...
                    >
                        <Button
                            sx={{ aspectRatio: "1/1", margin: 0, minWidth: "0px", minHeight: "0px", padding: "3px" }}
                            size="small"
                            variant="outlined"
                            color="secondary"
                            onClick={() =>

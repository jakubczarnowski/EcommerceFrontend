            ...
            <Box sx={{ display: "flex", flexDirection: "column", justifyContent: "center" }}>
                <Box sx={{ display: "flex", flexDirection: "row" }}>
                    ...
                    <Box sx={{ display: "flex", flexDirection: "column", justifyContent: "center" }}>
                        <Typography
                            variant="h5"
                            sx={{ textTransform: "capitalize", marginX: "5px", fontSize: "16px", fontWeight: "500" }}
                        >
                            {name}
                        </Typography>
                        <Box sx={{ display: "flex", alignItems: "center", gap: "5px" }}>
                            <Rating value={rating} readOnly></Rating>
                            <Typography sx={{ marginX: "5px", fontSize: "16px", fontWeight: "500" }}>
                                {rating.toFixed(1)}
                            </Typography>
                            <Typography sx={{ MarginX: "5px", fontSize: "16px", fontWeight: "400" }}>
